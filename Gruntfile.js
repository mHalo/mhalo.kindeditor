...
return KindEditor;
      ...
      build: {
        ...
        dest: "publish/temp/kindeditor-all.js",
      },
    },
	babel: {
		options: {
		...
		dist: {
			files: [{
			   src: 'publish/temp/kindeditor-all.js', //所有js文件
			   dest: 'publish/dist/kindeditor-all.js'  //输出到此目录下
			 }]
		}
	},
    uglify: {
  ...
  grunt.registerTask("build", ["concat", "babel", "uglify", "copy"]);
