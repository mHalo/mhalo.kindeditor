...
(function (global, factory) {
  typeof exports !== 'undefined' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = global || self, global.KindEditor = factory());
})(void 0, function () {
  (function (window) {
  ...
  !function (t, e) {
    ...
    var e = function () {
      function $(t) {
        return null == t ? String(t) : C[O.call(t)] || "object";
      }
      function j(t) {
        return "function" == $(t);
      }
      ...
      function R(t) {
        return "children" in t ? f.call(t.children) : i.map(t.childNodes, function (t) {
      ...
      function X(t, i, r) {
        for (n in i) r && (F(i[n]) || L(i[n])) ? (F(i[n]) && !F(t[n]) && (t[n] = {}), L(i[n]) && !L(t[n]) && (t[n] = []), X(t[n], i[n], r)) : i[n] !== e && (t[n] = i[n]);
      }
      function Y(t, e) {
      ...
      return S.matches = function (t, e) {
        ...
        var i,
          r = t.parentNode,
          o = !r;
        return o && (r = T).appendChild(t), i = ~S.qsa(r, e).indexOf(t), o && T.removeChild(t), i;
      }, A = function A(t) {
        ...
        var o, s, u;
        return d.test(t) && (o = i(a.createElement(RegExp.$1))), o || (t.replace && (t = t.replace(m, "<$1></$2>")), n === e && (n = p.test(t) && RegExp.$1), n in x || (n = "*"), u = x[n], u.innerHTML = "" + t, o = i.each(f.call(u.childNodes), function () {
          u.removeChild(this);
        })), F(r) && (s = i(o), i.each(r, function (t, e) {
        ...
        if (!t) return S.Z();
        if ("string" == typeof t) {
          if (t = t.trim(), "<" == t[0] && p.test(t)) r = S.fragment(t, RegExp.$1, n), t = null;else {
            if (n !== e) return i(n).find(t);
            r = S.qsa(a, t);
          }
        } else {
          if (j(t)) return i(a).ready(t);
          if (S.isZ(t)) return t;
          if (L(t)) r = V(t);else if (M(t)) r = [t], t = null;else if (p.test(t)) r = S.fragment(t.trim(), RegExp.$1, n), t = null;else {
            if (n !== e) return i(n).find(t);
            r = S.qsa(a, t);
          }
        }
        ...
        var n,
          ...
          o = i || r ? e.slice(1) : e,
          s = N.test(o);
        return t.getElementById && s && i ? (n = t.getElementById(o)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType && 11 !== t.nodeType ? [] : f.call(s && !i && t.getElementsByClassName ? r ? t.getElementsByClassName(o) : t.getElementsByTagName(e) : t.querySelectorAll(e));
      }, i.contains = a.documentElement.contains ? function (t, e) {
        return t !== e && t.contains(e);
      } : function (t, e) {
        for (; e && (e = e.parentNode);) if (e === t) return !0;
        return !1;
      }, i.type = $, i.isFunction = j, i.isWindow = D, i.isArray = L, i.isPlainObject = F, i.isEmptyObject = function (t) {
        var e;
        for (e in t) return !1;
        return !0;
      ...
      }, i.camelCase = A, i.trim = function (t) {
        ...
        ready: function ready(e) {
          if ("complete" === a.readyState || "loading" !== a.readyState && !a.documentElement.doScroll) setTimeout(function () {
            e(i);
          }, 0);else {
            var n = function n() {
              a.removeEventListener("DOMContentLoaded", n, !1), t.removeEventListener("load", n, !1), e(i);
            };
            a.addEventListener("DOMContentLoaded", n, !1), t.addEventListener("load", n, !1);
          }
          return this;
        },
        get: function get(t) {
        ...
        filter: function filter(t) {
          return j(t) ? this.not(this.not(t)) : i(u.call(this, function (e) {
        ...
        is: function is(t) {
          return "string" == typeof t ? this.length > 0 && S.matches(this[0], t) : t && this.selector == t.selector;
        },
        not: function not(t) {
          var n = [];
          if (j(t) && t.call !== e) this.each(function (e) {
            t.call(this, e) || n.push(this);
          });else {
            var r = "string" == typeof t ? this.filter(t) : z(t) && j(t.item) ? f.call(t) : i(t);
        ...
        has: function has(t) {
          return this.filter(function () {
            return M(t) ? i.contains(this, t) : i(this).find(t).size();
          });
        },
        eq: function eq(t) {
        ...
        find: function find(t) {
          var e,
            n = this;
          return e = t ? "object" == _typeof(t) ? i(t).filter(function () {
            var t = this;
        ...
        closest: function closest(t, e) {
          var n = [],
            r = "object" == _typeof(t) && i(t);
          return this.each(function (i, o) {
            for (; o && !(r ? r.indexOf(o) >= 0 : S.matches(o, t));) o = o !== e && !Z(o) && o.parentNode;
        ...
        siblings: function siblings(t) {
          return Y(this.map(function (t, e) {
            return u.call(R(e.parentNode), function (t) {
              return t !== e;
            });
          }), t);
        },
        ...
        attr: function attr(t, i) {
          var r;
          return "string" != typeof t || 1 in arguments ? this.each(function (e) {
            if (1 === this.nodeType) if (M(t)) for (n in t) U(this, n, t[n]);else U(this, t, J(this, i, e, this.getAttribute(t)));
        ...
        prop: function prop(t, e) {
          return t = k[t] || t, "string" != typeof t || 1 in arguments ? this.each(function (i) {
            if (M(t)) for (n in t) this[k[n] || n] = t[n];else this[t] = J(this, e, i, this[t]);
          }) : this[0] && this[0][t];
        },
        ...
        offset: function offset(e) {
          ...
          if (a.documentElement !== this[0] && !i.contains(a.documentElement, this[0])) return {
            top: 0,
            left: 0
          };
          ...
          if (arguments.length < 2) {
            ...
            if (L(t)) {
              ...
              return i.each(t, function (t, e) {
                o[e] = r.style[A(e)] || s.getPropertyValue(e);
              }), o;
            }
          }
          var u = "";
          if ("string" == $(t)) e || 0 === e ? u = _(t) + ":" + B(t, e) : this.each(function () {
            this.style.removeProperty(_(t));
          });else for (n in t) t[n] || 0 === t[n] ? u += _(n) + ":" + B(n, t[n]) + ";" : this.each(function () {
        ...
        offsetParent: function offsetParent() {
          return this.map(function () {
            for (var t = this.offsetParent || a.body; t && !g.test(t.nodeName) && "static" == i(t).css("position");) t = t.offsetParent;
            return t;
          });
        }
        ...
        i.fn[t] = function (r) {
          var o,
            s = this[0];
          return r === e ? D(s) ? s["inner" + n] : Z(s) ? s.documentElement["scroll" + n] : (o = this.offset()) && o[t] : this.each(function (e) {
        ...
        i.fn[n] = function () {
          ...
          return s.length < 1 ? this : this.each(function (e, n) {
            u = o ? n : n.parentNode, n = 0 == r ? n.nextSibling : 1 == r ? n.firstChild : 2 == r ? n : null;
            var c = i.contains(a.documentElement, u);
            s.forEach(function (e) {
              if (f) e = e.cloneNode(!0);else if (!u) return i(e).remove();
              u.insertBefore(e, n), c && Q(e, function (e) {
      ...
      }), S.Z.prototype = H.prototype = i.fn, S.uniq = P, S.deserializeValue = K, i.zepto = S, i;
    }();
    return t.Zepto = e, void 0 === t.$ && (t.$ = e), function (e) {
      ...
      function p(t, e, n, i) {
        ...
        return (u[h(t)] || []).filter(function (t) {
      ...
      function y(t, n, r, o, s, f, a) {
        var c = h(t),
          p = u[c] || (u[c] = []);
        n.split(/\s/).forEach(function (n) {
          if ("ready" == n) return e(document).ready(r);
          var u = d(n);
          u.fn = r, u.sel = s, u.e in l && (r = function r(t) {
            var n = t.relatedTarget;
            return !n || n !== this && !e.contains(this, n) ? u.fn.apply(this, arguments) : void 0;
          }), u.del = f;
          var c = f || r;
          u.proxy = function (e) {
          ...
          }, u.i = p.length, p.push(u), "addEventListener" in t && t.addEventListener(v(u.e), u.proxy, g(u, a));
        });
      }
      function b(t, e, n, i, r) {
        ...
        (e || "").split(/\s/).forEach(function (e) {
          p(t, e, n, i).forEach(function (e) {
            delete u[o][e.i], "removeEventListener" in t && t.removeEventListener(v(e.e), e.proxy, g(e, r));
          });
        });
      }
      function C(t, n) {
        if (n || !t.isDefaultPrevented) {
          n || (n = t), e.each(N, function (e, i) {
            var r = n[e];
            t[e] = function () {
          ...
          (n.defaultPrevented !== i ? n.defaultPrevented : "returnValue" in n ? n.returnValue === !1 : n.getPreventDefault && n.getPreventDefault()) && (t.isDefaultPrevented = E);
        }
        return t;
      }
      function O(t) {
        ...
        for (e in t) x.test(e) || t[e] === i || (n[e] = t[e]);
        return C(n, t);
      }
      var i,
        n = 1,
      ...
      e.fn.delegate = function (t, e, n) {
      ...
      }, e.fn.on = function (t, n, u, f, a) {
        var c,
          l,
          h = this;
        return t && !s(t) ? (e.each(t, function (t, e) {
          h.on(t, n, u, e, a);
        }), h) : (s(n) || o(f) || f === !1 || (f = u, u = n, n = i), (f === i || u === !1) && (f = u, u = i), f === !1 && (f = w), h.each(function (i, o) {
          a && (c = function c(t) {
            return b(o, t.type, f), f.apply(this, arguments);
          }), n && (l = function l(t) {
            var i,
              s = e(t.target).closest(n, o).get(0);
            return s && s !== o ? (i = e.extend(O(t), {
              currentTarget: s,
              liveFired: o
            }), (c || f).apply(s, [i].concat(r.call(arguments, 1)))) : void 0;
          }), y(o, t, f, u, n, l || c);
        }));
        ...
        return t && !s(t) ? (e.each(t, function (t, e) {
          u.off(t, n, e);
        }), u) : (s(n) || o(r) || r === !1 || (r = n, n = i), r === !1 && (r = w), u.each(function () {
          b(this, t, r, n);
        }));
      }, e.fn.trigger = function (t, n) {
        return t = s(t) || e.isPlainObject(t) ? e.Event(t) : C(t), t._args = n, this.each(function () {
        ...
        return this.each(function (o, u) {
          i = O(s(t) ? e.Event(t) : t), i._args = n, i.target = u, e.each(p(u, t.type || t), function (t, e) {
      ...
      t.when = function (i) {
        var a,
          ...
          o = r.length,
          s = 0,
          u = 1 !== o || i && t.isFunction(i.promise) ? o : 0,
          f = 1 === u ? i : n(),
          h = function h(t, n, i) {
            return function (r) {
              n[t] = this, i[t] = arguments.length > 1 ? e.call(arguments) : r, i === a ? f.notifyWith(n, i) : --u || f.resolveWith(n, i);
            };
          };
        if (o > 1) for (a = new Array(o), c = new Array(o), l = new Array(o); o > s; ++s) r[s] && t.isFunction(r[s].promise) ? r[s].promise().done(h(s, l, r)).fail(f.reject).progress(h(s, c, a)) : --u;
        return u || f.resolveWith(l, r), f.promise();
      }, t.Deferred = n;
    }(e), function (t) {
      t.Callbacks = function (e) {
        ...
        var n,
          ...
          a = !e.once && [],
          c = function c(t) {
            for (n = e.memory && t, i = !0, u = o || 0, o = 0, s = f.length, r = !0; f && s > u; ++u) if (f[u].apply(t[0], t[1]) === !1 && e.stopOnFalse) {
              n = !1;
              break;
            }
            r = !1, f && (a ? a.length && c(a.shift()) : n ? f.length = 0 : l.disable());
          },
          l = {
            add: function add() {
              if (f) {
                var i = f.length,
                  u = function u(n) {
                    t.each(n, function (t, n) {
                      "function" == typeof n ? e.unique && l.has(n) || f.push(n) : n && n.length && "string" != typeof n && u(n);
                    });
                  };
                u(arguments), r ? s = f.length : n && (o = i, c(n));
              }
              return this;
            },
            remove: function remove() {
              return f && t.each(arguments, function (e, n) {
                for (var i; (i = t.inArray(n, f, i)) > -1;) f.splice(i, 1), r && (s >= i && --s, u >= i && --u);
              }), this;
            },
            has: function has(e) {
              return !(!f || !(e ? t.inArray(e, f) > -1 : f.length));
            },
            empty: function empty() {
              return s = f.length = 0, this;
            },
            disable: function disable() {
              return f = a = n = void 0, this;
            },
            ...
            fireWith: function fireWith(t, e) {
              return !f || i && !a || (e = e || [], e = [t, e.slice ? e.slice() : e], r ? a.push(e) : c(e)), this;
            },
            fire: function fire() {
  ...
  !function (a, b) {
    ...
    c = a.WebUploader, a.WebUploader = j(), a.WebUploader.noConflict = function () {
      a.WebUploader = c;
    };
    ...
    return b("dollar-third", [], function () {
      ...
      function f(a) {
        var b;
        return Object.create ? Object.create(a) : (b = function b() {}, b.prototype = a, new b());
      }
      var g = function g() {},
        h = Function.call;
      return {
        ...
        inherits: function inherits(a, c, d) {
          var e;
      ...
      return e = {
        ...
        installTo: function installTo(a) {
          return f.extend(a, e);
        }
      }, e);
      ...
      return e.options = {
        ...
        refresh: function refresh() {
          var a = this.getRuntime().getContainer(),
            ...
            d = b[0] && b[0].offsetHeight || b.outerHeight() || b.height(),
            e = b.offset();
          c && d && a.css({
            bottom: "auto",
            right: "auto",
      ...
      return d = function (a) {
        ...
        name: "image",
        makeThumb: function makeThumb(a, b, f, g) {
          var h, i;
      ...
      var e = a.$,
        ...
        i = {};
      return e.extend(d.prototype, {
        setStatus: function setStatus(a, b) {
          var c = i[this.id];
      ...
      return d.options = {
        ...
        appendBlob: function appendBlob(a, b, c) {
          var d = this,
            e = d.options;
        ...
        append: function append(a, b) {
          "object" == _typeof(a) ? e.extend(this._formData, a) : this._formData[a] = b;
        },
        setRequestHeader: function setRequestHeader(a, b) {
          "object" == _typeof(a) ? e.extend(this._headers, a) : this._headers[a] = b;
        },
      ...
      f.extend(b.options, {
        ...
        _tick: function _tick() {
          var b,
            ...
            d = this,
            e = d.options;
          return d._promise ? d._promise.always(d.__tick) : (d.pool.length < e.threads && (c = d._nextBlock()) ? (d._trigged = !1, b = function b(_b) {
            d._promise = null, _b && _b.file && d._startSend(_b), a.nextTick(d.__tick);
        ...
        _nextBlock: function _nextBlock() {
          var a,
            ...
            f = this,
            h = f.options;
          return (a = this._getStack()) ? (h.prepareNextFile && !f.pending.length && f._prepareNextFile(), a.shift()) : f.runing ? (!f.pending.length && f._getStats().numOfQueue && f._prepareNextFile(), b = f.pending.shift(), c = function c(b) {
        ...
        _doSend: function _doSend(b) {
          var c,
            ...
            g = this,
            i = g.owner,
            j = f.extend({}, g.options, b.options),
            k = b.file,
            l = new d(j),
          ...
          b.transport = l, l.on("destroy", function () {
            ...
            var c;
            return e = l.getResponseAsJson() || {}, e._raw = l.getResponse(), e._headers = l.getResponseHeaders(), b.response = e, c = function c(b) {
              a = b;
      ...
      var d,
        ...
        f = {};
      return d = {
        addValidator: function addValidator(a, b) {
          f[a] = b;
        },
      ...
      return b.register("FilePicker", {
        init: function init() {
          var a,
            ...
            e,
            _f,
            g = this.getRuntime().getContainer(),
            h = this,
            i = h.owner,
            j = h.options,
          ...
          g.append(l), g.append(k), e = function e(a) {
            i.trigger(a.type);
          }, _f = function f(a) {
            var b;
            return 0 === a.target.files.length ? !1 : (h.files = a.target.files, b = this.cloneNode(!0), b.value = null, this.parentNode.replaceChild(b, this), l.off(), l = c(b).on("change", _f).on("mouseenter mouseleave", e), i.trigger("change"), void 0);
          }, l.on("change", _f), k.on("mouseenter mouseleave", e);
        },
        getFiles: function getFiles() {
          return this.files;
        },
      ...
      return c && (d = function d() {
        ...
        createObjectURL: d,
        revokeObjectURL: e,
        dataURL2Blob: function dataURL2Blob(a) {
          var b, c, d, e, f, g;
      ...
      return c.ExifMap = function () {
        ...
        3: {
          getValue: function getValue(a, b, c) {
      ...
      return b.register("Transport", {
        ...
        _parseHeader: function _parseHeader(a) {
          var b = {};
  ...
  K.Tools = {
    All: ['source', '|', 'undo', 'redo', 'removeformat', 'clearhtml', '|', 'template', 'code', 'cut', 'copy', 'plainpaste', 'wordpaste', '|', 'preview', 'selectall', 'fullscreen', 'print', '|', 'quickformat', '/', 'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', '|', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'lineheight', '/', 'quote', 'subscript', 'superscript', '|', 'image', 'multiimage', 'media', 'insertfile', 'baidumap', 'link', 'unlink', '|', 'table', 'anchor', 'hr', 'pagebreak', '|', 'emoticons', 'symbols'],
    Normal: ['source', '|', 'formatblock', 'fontname', 'fontsize', '|', 'forecolor', 'hilitecolor', 'bold', 'italic', 'underline', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', '|', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'lineheight', '/', 'image', 'multiimage', 'media', 'insertfile', 'baidumap', 'link', 'unlink', '|', 'table', 'anchor', 'hr', 'pagebreak', '|', 'quote', 'subscript', 'superscript', '|', 'preview', 'fullscreen', 'quickformat', 'emoticons', 'symbols'],
    Small: ['source', '|', 'formatblock', 'fontname', 'fontsize', '|', 'bold', 'italic', 'underline', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', '|', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'lineheight', '/', 'quote', 'image', 'multiimage', 'media', 'insertfile', '|', 'table', 'hr', 'pagebreak', '|', 'link', 'unlink', '|', 'preview', 'fullscreen'],
    Mini: ['formatblock', 'bold', 'italic', 'underline', 'strikethrough', '|', 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', '|', 'insertorderedlist', 'insertunorderedlist', '|', 'image', 'insertfile', 'table', 'link', 'unlink']
  };
  K.Templates = [{
    name: '图片和文字',
  ...
  K.options = {
    ...
    colorTable: [['#1abc9c', '#2ecc71', '#3498db', '#9b59b6', '#4e5f70', '#f1c40f'], ['#16a085', '#27ae60', '#2980b9', '#8e44ad', '#2c3e50', '#f39c12'], ['#E53333', '#E56600', '#FF9900', '#64451D', '#DFC5A4', '#FFE500'], ['#009900', '#006600', '#99BB00', '#B8D100', '#60D978', '#00D5FF'], ['#337FE5', '#003399', '#4C33E5', '#9933E5', '#CC33E5', '#EE33EE'], ['#FFFFFF', '#CCCCCC', '#999999', '#666666', '#333333', '#000000']],
  ...
  _extend(KNode, {
    ...
    clone: function clone(bool) {
      if (this.length < 1) {
        return new KNode([]);
      }
      return new KNode(this[0].cloneNode(bool));
    },
    append: function append(expr) {
      this.each(function () {
        if (this.appendChild) {
    ...
    appendTo: function appendTo(expr) {
      this.each(function () {
        _get(expr).appendChild(this);
      });
      return this;
    },
    before: function before(expr) {
      this.each(function () {
        this.parentNode.insertBefore(_get(expr), this);
      });
      return this;
    },
    after: function after(expr) {
      this.each(function () {
        if (this.nextSibling) {
    ...
    remove: function remove(keepChilds) {
      var self = this;
      self.each(function (i, node) {
        if (!node.parentNode) {
          return;
    ...
    contains: function contains(otherNode) {
      if (this.length < 1) {
        return false;
      }
  ...
  _extend(KRange, {
    ...
    commonAncestor: function commonAncestor() {
    ...
    get: function get(hasControlRange) {
      var self = this,
        doc = self.doc,
        node,
        rng;
    ...
    enlarge: function enlarge(toBlock) {
      var self = this;
      self.up();
    ...
    createBookmark: function createBookmark(serialize) {
      var self = this,
        doc = self.doc,
        endNode,
  ...
  _extend(KCmd, {
    init: function init(range, options) {
      var self = this,
        doc = range.doc;
      self.doc = doc;
    ...
    selection: function selection(forceReset) {
      var self = this,
        doc = self.doc,
        rng = _getRng(doc);
      self.sel = _getSel(doc);
    ...
    select: function select(hasDummy) {
    ...
    split: function split(isStart, map) {
    ...
    commonNode: function commonNode(map) {
      var range = this.range;
      var ec = range.endContainer,
        eo = range.endOffset,
    ...
    commonAncestor: function commonAncestor(tagName) {
      var range = this.range,
        sc = range.startContainer,
        so = range.startOffset,
        ec = range.endContainer,
    ...
    toggle: function toggle(wrapper, map) {
      var self = this;
    ...
    forecolor: function forecolor(val) {
      return this.wrap('<span style="color:' + val + ';"></span>').select();
    },
    hilitecolor: function hilitecolor(val) {
      return this.wrap('<span style="background-color:' + val + ';"></span>').select();
    },
    fontsize: function fontsize(val) {
      return this.wrap('<span style="font-size:' + val + ';"></span>').select();
    },
    fontname: function fontname(val) {
    ...
    inserthtml: function inserthtml(val, quickMode) {
      var self = this,
        range = self.range;
      if (val === '') {
        return self;
    ...
    insertimage: function insertimage(url, title, width, height, border, align, cls, wrapper) {
      title = _undef(title, '');
    ...
    createlink: function createlink(url, type) {
      var self = this,
        doc = self.doc,
        range = self.range;
      self.select();
  ...
  _extend(KWidget, {
    ...
    pos: function pos(x, y, updateProp) {
      var self = this;
    ...
    autoPos: function autoPos(width, height) {
      var x,
        y,
        self = this,
  ...
  _extend(KToolbar, KWidget, {
    ...
    disableAll: function disableAll(bool, noDisableItems) {
      var self = this,
  ...
  _extend(KColorPicker, KWidget, {
    init: function init(options) {
      ...
      var colors = options.colors || [['#1abc9c', '#2ecc71', '#3498db', '#9b59b6', '#4e5f70', '#f1c40f'], ['#16a085', '#27ae60', '#2980b9', '#8e44ad', '#2c3e50', '#f39c12'], ['#E53333', '#E56600', '#FF9900', '#64451D', '#DFC5A4', '#FFE500'], ['#009900', '#006600', '#99BB00', '#B8D100', '#60D978', '#00D5FF'], ['#337FE5', '#003399', '#4C33E5', '#9933E5', '#CC33E5', '#EE33EE'], ['#FFFFFF', '#CCCCCC', '#999999', '#666666', '#333333', '#000000']];
    ...
    _addAttr: function _addAttr(cell, color, cls) {
      var self = this;
  ...
  _extend(KDialog, KWidget, {
    ...
    setMaskIndex: function setMaskIndex(z) {
      var self = this;
  ...
  function _bindNewlineEvent() {
    ...
    K(doc).keyup(function (e) {
      ...
      var tagName = tag.name,
        parentTagName = parent && parent.name ? parent.name : '';
  ...
  KEditor.prototype = {
    lang: function lang(mixed) {
      return _lang(mixed, this.langType);
    },
    loadPlugin: function loadPlugin(name, fn) {
      var self = this;
    ...
    handler: function handler(key, fn) {
      var self = this;
    ...
    clickToolbar: function clickToolbar(name, fn) {
      var self = this,
    ...
    addContextmenu: function addContextmenu(item) {
      this._contextmenus.push(item);
      return this;
    },
    afterCreate: function afterCreate(fn) {
      return this.handler('afterCreate', fn);
    },
    beforeRemove: function beforeRemove(fn) {
      return this.handler('beforeRemove', fn);
    },
    beforeGetHtml: function beforeGetHtml(fn) {
      return this.handler('beforeGetHtml', fn);
    },
    beforeSetHtml: function beforeSetHtml(fn) {
      return this.handler('beforeSetHtml', fn);
    },
    afterSetHtml: function afterSetHtml(fn) {
    ...
    create: function create() {
      ...
      var edit = self.edit = _edit({
        ...
        beforeGetHtml: function beforeGetHtml(html) {
          html = self.beforeGetHtml(html);
          html = _removeBookmarkTag(_removeTempTag(html));
          return _formatHtml(html, self.filterMode ? self.htmlTags : null, self.urlType, self.wellFormatMode, self.indentChar);
        },
        beforeSetHtml: function beforeSetHtml(html) {
      ...
      statusbar.removeClass('statusbar').addClass('ke-statusbar').append('<span class="ke-inline-block ke-statusbar-center-icon"><i></i><i></i><i></i></span>').append('<span class="ke-inline-block ke-statusbar-right-icon"></span>');
      ...
      if (fullscreenMode) {
        ...
        if (self.resizeType > 0) {
          _drag({
            moveEl: container,
            clickEl: statusbar,
            moveFn: function moveFn(x, y, width, height, diffX, diffY) {
              height += diffY;
    ...
    resize: function resize(width, height, updateProp) {
      var self = this;
      updateProp = _undef(updateProp, true);
      if (width) {
        if (!/%/.test(width)) {
    ...
    selectedHtml: function selectedHtml() {
      var val = this.isCreated ? this.cmd.range.html() : '';
      val = _removeBookmarkTag(_removeTempTag(val));
      return val;
    },
    count: function count(mode) {
      var self = this;
    ...
    appendHtml: function appendHtml(val) {
    ...
    addBookmark: function addBookmark(checkSize) {
    ...
    createMenu: function createMenu(options) {
      var self = this,
        name = options.name,
    ...
    errorDialog: function errorDialog(html) {
      var self = this;
  ...
  KindEditor.plugin('anchor', function (K) {
    ...
    self.plugin.anchor = {
      edit: function edit() {
        var html = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keName">' + lang.name + '</label>', '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:260px;" />', '</div>', '</div>'].join('');
        var dialog = self.createDialog({
          name: name,
          width: 360,
  ...
  * */
      ...
      var dialog = self.createDialog({
        ...
        yesBtn: {
          ...
          click: function click(e) {
            ...
            var url = ['http://api.map.baidu.com/staticimage/v2?ak=' + baiduMapAk, '&center=' + encodeURIComponent(center), '&zoom=' + encodeURIComponent(zoom), '&width=' + mapWidth * 1.5, '&height=' + mapHeight * 1.5, '&markers=' + encodeURIComponent(center), '&markerStyles=' + encodeURIComponent('l,A')].join('');
            if (false) {
  ...
  KindEditor.plugin('emoticons', function (K) {
    ...
    self.clickToolbar(name, function () {
      ...
      var table = emojiTable(page.current, wrapperDiv),
        pageDiv;
  ...
  KindEditor.plugin('symbols', function (K) {
    ...
    self.clickToolbar(name, function () {
      ...
      var table = symbolTable(page.current, wrapperDiv),
        pageDiv;
      var tableWidth = K(wrapperDiv).width();
      if (iconLeft + tableWidth > winWidth) {
        K(menu.div).css({
  ...
  KindEditor.plugin('image', function (K) {
    ...
    self.plugin.imageDialog = function (options) {
      ...
      var html = ['<div style="padding:20px;">', '<div class="tabs"></div>', '<div class="tab1" style="display:none;">', '<div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' + lang.remoteUrl + '</label>', '<input type="text" id="remoteUrl" class="ke-input-text" name="url" value="" style="width:' + (allowFileManager ? 250 : 360) + 'px;" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (allowFileManager ? 12 : 0) + 'px">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />', '</span>', '</div>', '<div class="ke-dialog-row">', '<label for="remoteWidth" style="width:60px;">' + lang.size + '</label>', lang.width + '：<input type="text" id="remoteWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" style="width:130px;margin-right:10px" />', lang.height + '：<input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" style="width:130px;margin-right:10px" />', '<span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-refresh-bold ke-refresh-btn"></span>', '</div>', '<div class="ke-dialog-row">', '<label style="width:60px;">' + lang.align + '</label>', '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-default"></span><text style="margin-right:30px;">&nbsp;默认</text>', ' <input type="radio" name="align" class="ke-inline-block" value="left" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-left"></span><text style="margin-right:30px;">&nbsp;左对齐</text>', ' <input type="radio" name="align" class="ke-inline-block" value="right" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-right"></span><text style="margin-right:30px;" >&nbsp;右对齐</text>', '</div>', '<div class="ke-dialog-row">', '<label for="remoteTitle" style="width:60px;">' + lang.imgTitle + '</label>', '<input type="text" id="remoteTitle" class="ke-input-text" name="title" value="" style="width:360px;" />', '</div>', '</div>', '<div class="tab2" style="display:none;">', '<div class="ke-dialog-row">', '<label style="width:60px;">' + lang.localUrl + '</label>', '<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:270px;" readonly="true" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + lang.upload + '" />', '</div>', '</div>', '</div>'].join('');
      var dialogWidth = 480,
      ...
      if (showRemote && showLocal) {
        tabs = K.tabs({
          src: K('.tabs', div),
          afterSelect: function afterSelect(i) {}
        });
        tabs.add({
      ...
      var uploadbutton = K.uploadbutton({
        ...
        afterError: function afterError(html) {
          dialog.hideLoading();
        ...
        viewServerBtn.click(function (e) {
          self.loadPlugin('filemanager', function () {
            self.plugin.filemanagerDialog({
              viewType: 'VIEW',
              dirName: 'image',
              clickFn: function clickFn(url, title) {
  ...
  KindEditor.plugin('link', function (K) {
    ...
    self.plugin.link = {
      edit: function edit() {
        var lang = self.lang(name + '.'),
          html = '<div style="padding:20px;">' + '<div class="ke-dialog-row">' + '<label for="keUrl" style="width:60px;">' + lang.url + '</label>' + '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:260px;" /></div>' + '<div class="ke-dialog-row"">' + '<label for="keType" style="width:60px;">' + lang.linkType + '</label>' + '<select id="keType" name="type"></select>' + '</div>' + '</div>',
          dialog = self.createDialog({
            name: name,
            width: 450,
            title: self.lang(name),
  ...
  KindEditor.plugin('media', function (K) {
    var self = this,
      ...
      uploadJson = K.undef(self.uploadJson, self.basePath + '_404.html'),
      formatUploadUrl = K.undef(self.formatUploadUrl, true);
    var getAncestorTag = function getAncestorTag(range) {
      var ancestor = K(range.commonAncestor());
      while (ancestor) {
        if (ancestor.type == 1 && !ancestor.isStyle()) {
          break;
    ...
    self.plugin.media = {
      edit: function edit() {
        var html = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + lang.url + '</label>', '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:' + (allowFileManager ? 160 : 260) + 'px;" />', '<input type="button" class="ke-upload-button" value="' + lang.upload + '" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (allowFileManager ? 5 : 0) + 'px" >', '<input type="button" class="ke-button-common ke-button " name="viewServer" value="' + lang.viewServer + '" />', '</span>', '</div>', '<div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + lang.width + '</label>', '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="320" maxlength="4" />', '<label for="keHeight" style="width:60px;text-align:left;margin-left:30px">' + lang.height + '</label>', '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="auto" maxlength="4" />', '</div>', '<div class="ke-dialog-row">', '<label for="kePreload" style="width:60px;">预加载</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="kePreload" name="preload" value="" /></div>', '<label for="keAutostart" style="width:60px;text-align:left;margin-left:30px">自动播放</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keAutostart" name="autoplay" value="" /></div>', '</div>', '<div class="ke-dialog-row">', '<label for="keControls" style="width:60px;">控制按钮</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keControls" name="controls" checked value="" /></div>', '<label for="keLoop" style="width:60px;text-align:left;margin-left:30px">循环播放</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keLoop" name="loop" checked value="" /></div>', '</div>', '</div>'].join('');
        var dialog = self.createDialog({
            name: name,
            width: 450,
            height: 300,
            ...
            yesBtn: {
              ...
              click: function click(e) {
                ...
                var html = ['<p><' + mediaType, 'data-ke-class="ke-audio"', 'class="ke-media"', 'style="display:inline;"', 'src="' + url + '"', 'width="' + width + '"', 'height="' + height + '"', preload ? 'preload' : '', autoplay ? 'autoplay' : '', controls ? 'controls' : '', loop ? 'loop' : '', '></' + mediaType + "><span>\u200B\u3000</span></p>"].join(' ');
                var tag = getAncestorTag(self.cmd.range);
                if (tag && tag.name != 'p') {
                  self.insertHtml(html).hideDialog().focus();
                } else {
  ...
  (function (K) {
    ...
    K.extend(KSWFUpload, {
      init: function init(options) {
        ...
        self.div = K(options.container).html(['<div class="ke-swfupload">', '<div class="ke-swfupload-top" >', '<div class="ke-inline-block ke-swfupload-button" id="' + handleBtnId + '" style="width: 86px;">', '</div>', '<div class="ke-inline-block ke-swfupload-desc">' + options.uploadDesc + '</div>', '<span class="ke-button-common ke-button-outer ke-swfupload-startupload">', '<input type="button" class="ke-button-common ke-button ke-startup-upload-button" value="' + options.startButtonValue + '" />', '</span>', '</div>', '<div class="ke-swfupload-body" id="' + dragBodyId + '"></div>', '<div class="upload-error-result" id="' + uploadErrorId + '"></div>', '</div>'].join(''));
        ...
        self.uploader = WebUploader.create({
          ...
          uploadBeforeSend: function uploadBeforeSend(object, data, headers) {},
          headers: options.uploadHeader,
          formData: options.uploadData,
  ...
  KindEditor.plugin('multiimage', function (K) {
    ...
    self.plugin.multiImageDialog = function (options) {
      ...
      var html = ['<div style="padding:10px 20px;">', '<div class="swfupload">', '</div>', '</div>'].join('');
      var dialog = self.createDialog({
          name: name,
          width: 650,
          height: 500,
    ...
    self.clickToolbar(name, function () {
      self.plugin.multiImageDialog({
        clickFn: function clickFn(urlList) {
          if (urlList.length === 0) {
            return;
          }
  ...
  KindEditor.plugin('plainpaste', function (K) {
    ...
    self.clickToolbar(name, function () {
      var lang = self.lang(name + '.'),
        html = '<div style="padding:10px 20px;">' + '<div style="margin-bottom:10px;">' + lang.comment + '</div>' + '<textarea class="ke-textarea" style="width:518px;height:260px;"></textarea>' + '</div>',
        dialog = self.createDialog({
          name: name,
          width: 560,
          title: self.lang(name),
  ...
  KindEditor.plugin('preview', function (K) {
    ...
    self.clickToolbar(name, function () {
      var lang = self.lang(name + '.'),
        html = '<div style="padding:10px 20px;">' + '<iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe>' + '</div>',
        dialog = self.createDialog({
          name: name,
          width: 750,
          title: self.lang(name),
  ...
  KindEditor.plugin('table', function (K) {
    ...
    self.plugin.table = {
      ...
      colinsert: function colinsert(offset) {
      ...
      colinsertleft: function colinsertleft() {
        this.colinsert(0);
      },
      colinsertright: function colinsertright() {
        this.colinsert(1);
      },
      rowinsert: function rowinsert(offset) {
        var table = self.plugin.getSelectedTable()[0],
          row = self.plugin.getSelectedRow()[0],
          cell = self.plugin.getSelectedCell()[0];
      ...
      rowinsertabove: function rowinsertabove() {
        this.rowinsert(0);
      },
      rowinsertbelow: function rowinsertbelow() {
        this.rowinsert(1);
      },
      rowmerge: function rowmerge() {
        var table = self.plugin.getSelectedTable()[0],
          row = self.plugin.getSelectedRow()[0],
          cell = self.plugin.getSelectedCell()[0],
  ...
  KindEditor.plugin('template', function (K) {
    ...
    self.clickToolbar(name, function () {
      var lang = self.lang(name + '.'),
        arr = ['<div style="padding:10px 20px;">', '<div class="ke-header">', '<div class="ke-left">', lang.selectTemplate + ' <select>'];
      K.each(templates, function (i, o) {
        arr.push("<option value='" + o.content + "'>" + o.name + "</option>");
      });
      html = [arr.join(''), '</select></div>', '<div class="ke-right">', '<input type="checkbox" id="keReplaceFlag" name="replaceFlag" value="1" /> <label for="keReplaceFlag">' + lang.replaceContent + '</label>', '</div>', '<div class="ke-clearfix"></div>', '</div>', '<div class="ke-temp-preview" style="width:518px;height:260px;background-color:#FFF;padding: 12px;overflow:auto;border-color: #848484 #E0E0E0 #E0E0E0 #848484;border-style: solid;border-width: 1px;"></div>', '</div>'].join('');
      var dialog = self.createDialog({
        name: name,
        width: 560,
        title: self.lang(name),
  ...
  KindEditor.plugin('wordpaste', function (K) {
    ...
    self.clickToolbar(name, function () {
      var lang = self.lang(name + '.'),
        html = '<div style="padding:10px 20px;">' + '<div style="margin-bottom:10px;">' + lang.comment + '</div>' + '<iframe class="ke-textarea" frameborder="0" style="width:518px;height:260px;"></iframe>' + '</div>',
        dialog = self.createDialog({
          name: name,
          width: 560,
          title: self.lang(name),
